<?php
	...
	$parametros=null;
    $parametros["action"]="insere.php?tabela=voluntario";
    ...
    $parametros["name"]="cpf";
    $parametros["type"]="text";
    $parametros["class"]="form-control cpf";
    ...
    $parametros["modal_title"]="Novo voluntario";
    $parametros["btn_title"]="Cadastrar Voluntário";
    ...
    <div class="col-xs-12 col-sm-10 offset-sm-1 col-md-10 offset-md-1">
        ...
        <div id="parallax-image333">
             <?php
                 $m->exibe();
            ?><br>
        <h1 class="text-center" id="listar_animais_adocao">Voluntarios Cadastrados</h1><br><br>
        ...
        <div class="col-xs-12 col-sm-10 offset-sm-1 col-md-10 offset-md-1">
            <form>
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        <td for="cpf_b">CPF:</td>
                        <td colspan="3"><input type="text" name="cpf_b" id="cpf_b" class="form-control form-control-sm cpf"></td>
                    </tr>
        ...
        <span id="comentarios" class="text-center"></spsan>
    </div>

    <div class="row exibir_card_voluntarios text-center" id="voluntarios">
...
<?php
    ...
    if (isset($_GET["sucesso_voluntario"])) {
        echo
        "
            <script>
